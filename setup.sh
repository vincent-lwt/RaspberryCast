...
apt-get install -y lsof python-pip git wget omxplayer libnss-mdns fbi libglib2.0-dev libdbus-1-dev
echo "============================================================"
...
pip install youtube-dl bottle livestreamer omxplayer-wrapper
